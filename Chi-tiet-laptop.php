...
<div class="container-fluid">
    ...
    <ul class="ssg-breadcrumb">
         <?php
                        $slsp="select * from san_pham where id={$_GET['idlp']}";
                    ...
                    <li itemscope itemtype="https://data-vocabulary.org/Breadcrumb">
                                    <a itemprop="url" href="xem-sp-laptop.php?idloaicha=<?php echo $dc['loaicha_id'] ?>">
                        <span itemprop="title"><?php echo $dc['loaicha_name'];?></span>
                                            </a>
                            </li>
                    <li itemscope itemtype="https://data-vocabulary.org/Breadcrumb">
                                    <a itemprop="url" href="xem-sp-laptop.php?idloaicha=<?php echo $dc['loaicha_id']?>&idloaicon=<?php echo $dlc['loaicon_id']?>">
                        <span itemprop="title">Laptop <?php echo $dlc['loaicon_name'];?></span>
                                            </a>
                            </li>
            </ul>
</div>                    </div>
...
<div class="row">
    <div class="block-container">
         ...
         <?php
                        $sl="select * from san_pham where id={$_GET['idlp']}";
                        $kq=mysql_query($sl);
...
HĐH: Dos</p>
                    ...
                    if(get_data($fpt, $content)){

    
                    $tncc = save_all_fpt($content);
                    ...
                    if(isset($tncc))
                    {
                       ?>
                                            ...
                                            <span class="store-price"><?php echo $tncc ?></span>
                                            <div class="merchant-logo-wrapper">
                                                <div class="merchant-logo">
                                                    <img src="hinh/chu-ky-so-fpt-ca.jpg"
                                                         title="Lazada">
                                                </div>
                                            </div>
                                            ...
                                            <div class="first-product">
                                                <div class="store-product-img-wrapper">
                                                    <div class="store-product-img">
                                                        <img src="https://img.sosanhgia.com/images/80x0/4bd7120188054c2cb1c28c1a072cedab/laptop-dell-inspiron-3467-m20nr1-14inch-(den)-hang-phan-phoi-chinh-thuc.jpeg" alt="Laptop Dell Inspiron 3467 M20NR1 14inch (Đen) - Hãng phân phối chính thức - Lazada"
                                                ...
                                                <div class="product-detail">
                                                    ...
                                                    <div class="merchant-logo-wrapper">
                                                        ...
                                                        <div class="grey-text"><?php echo $tncc ?></div>
