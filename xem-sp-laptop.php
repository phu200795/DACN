            ...
            <section class="product  product-resize col-lg-3 col-md-3 col-sm-6 col-xs-6 fixheight" style="height: 313px;">
                <div class="product-wrapper">
                    <div class="thumbnail-wrapper left-block">
                        <a href="Chi-tiet-laptop.php?idlp=<?php echo $d['id'] ?>">
                    ...
                    <div class="meta-wrapper right-block">
                        <div class="pr-0 product-contents">
                            <h3 class="heading-title product-name">
                                <a href="Chi-tiet-laptop.php?idlp=<?php echo $d['id'] ?>"><?php echo $d['name'] ?></a>
                            </h3>
                            <span class="price">
...
<div class="menu-product ts-product-categories-widget">
    <div type="button" class="collapsed" data-toggle="collapse" data-target="#category_menu" aria-expanded="false">
        ...
        <div class="title-wrapper">
            <h3 class="hr_title heading-title"><a href="/san-pham/thoi-trang-15148" title="Thời trang"><?php echo $dc['loaicha_name'] ?></a></h3>
        </div>
    </div>
    <div class="block_content navbar-collapse collapse" aria-expanded="false" id="category_menu">
        ...
        <ul class='list-block product-categories tree dhtml'>
            <?php
             while($d=mysql_fetch_array($kq))
        {?>
<li><a href='xem-sp-laptop.php?idloaicha=<?php echo $_GET['idloaicha']?>&idloaicon=<?php echo $d['loaicon_id']?>'><span class='menu-icon'><i class='fa fa-check'></i></span> <span class='menu-label'><?php echo $d['loaicon_name'] ?></span></a></li>
